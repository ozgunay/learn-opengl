...
MyApplication::MyApplication(const Arguments& arguments) :
    ...
    const Utility::Resource rs{ "transformations-data" };
...
void MyApplication::drawEvent() {
    ...
    Matrix4 trans = Matrix4::translation({ 0.5f, -0.5f, 0.0f }) *
        Matrix4::rotationZ(Math::Rad(static_cast<float>(glfwGetTime())));

    _shader.setTransform(trans);
